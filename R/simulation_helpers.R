...
simulate_train_data <-  function (
  ...
  site_cell_map_with_areas <- merge(site_cell_map_raw, cell_areas_df, by.x="cell_id", by.y="cell_id")
  ...
  site_cell_map <- site_cell_map_with_areas[, c("site", "cell_id", "overlap_area_m2")]
